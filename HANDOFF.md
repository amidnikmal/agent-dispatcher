...
## Операционные уроки (2026-06-15)

Реальное поведение делегирования под нагрузкой — залипания, «отклонённые» вызовы,
которые всё равно стартуют detached-агентов, ненадёжные коммиты, нарушение изоляции
worktree, и паттерн жёсткого трекинга (короткие таймауты + проверка процессов/worktree
каждый ход + оркестратор сам коммитит/собирает) — см.
[ORCHESTRATION_LESSONS_2026-06-15.md](ORCHESTRATION_LESSONS_2026-06-15.md).
